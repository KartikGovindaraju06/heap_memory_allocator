...
SUBMIT_MESSAGE += "https://www.cs.cmu.edu/~18213/academicintegrity.html [y/N]: "
AUTOLAB = /afs/cs/academic/class/18213-m25/bin/autolabv3
...
.PHONY: format
format: $(FORMAT_FILES)
	$(LLVM_PATH)clang-format -style=file -i $(FORMAT_FILES)
